		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					//resource.TestCheckResourceAttr("kubernetes_cluster_role_binding.test", "rule.0.resources.1", "pods/log"),
					resource.TestCheckResourceAttr("kubernetes_cluster_role_binding.test", "subject.#", "1"),
					//resource.TestCheckResourceAttr("kubernetes_cluster_role_binding.test", "rule.0.verbs.0", "get"),
